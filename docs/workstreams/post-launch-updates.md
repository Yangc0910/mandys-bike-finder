...
- Status: Local, protected-preview, and simulator launch/recovery passes complete on 2026-06-11; TestFlight verification awaits a Capacitor-accessible staging URL.
...
Provide a stable release-candidate staging URL that does not require interactive Vercel authentication inside Capacitor. Then verify destructive-action confirmations, TestFlight, and final App Store captures on an iPhone-class simulator or physical device.

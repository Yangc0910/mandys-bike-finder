...
- Status: Local, protected-preview, simulator launch/recovery, native source capture, and marketing screenshot export passes complete on 2026-06-11; TestFlight verification awaits a Capacitor-accessible staging URL.
...
Provide a stable release-candidate staging URL that does not require interactive Vercel authentication inside Capacitor. Then verify destructive-action confirmations and TestFlight, and upload the completed `1320 x 2868` screenshot set to App Store Connect.
